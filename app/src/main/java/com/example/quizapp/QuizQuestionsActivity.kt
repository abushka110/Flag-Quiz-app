...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivImage = findViewById(R.id.iv_flagImage)

        tvOptionOne = findViewById(R.id.question_option_one)
        tvOptionTwo = findViewById(R.id.question_option_two)
        tvOptionThree = findViewById(R.id.question_option_three)
        tvOptionFour = findViewById(R.id.question_option_four)
